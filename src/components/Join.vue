 ...
 <el-container>
   ...
   <el-container >
     ...
     <el-aside width="300px">
         ...
         <br>
         <el-button class="left_menu" type="text" icon="el-icon-user-solid">个人中心</el-button>
         <br>
     </el-aside>
     ...
     <el-main>
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item :to="{ path: '/' }">我加入的项目</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/' }">加入项目</el-breadcrumb-item>
        </el-breadcrumb>
        <br>
        <el-main id="subcard">
          <br>
          <el-form :model="numberValidateForm" hide-required-asterisk ref="numberValidateForm" label-width="100px" class="demo-ruleForm">
            ...
            v-model.number="numberValidateForm.proj_no" placeholder="请输入项目的数字编号" autocomplete="off">
            </el-input>
            </el-form-item>
            <el-form-item>
              <el-button-group style="position:relative; left:-45px">
              <el-button type="primary" @click="submitForm('numberValidateForm')">加入项目</el-button>
        ...
        :before-close="handleClose">
         ...
         <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="dialogVisible = false">查看项目</el-button>
        </span>
        </el-dialog>
